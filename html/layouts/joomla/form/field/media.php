...
$attr .= !empty($class) ? ' class="input-small field-media-input form-control ' . $class . '"' : ' class="input-small"';
...
if ($showPreview)
{
	...
	if ($showAsTooltip)
	{
		echo '<div class="media-preview input-group-addon">';
	...
	{
		echo '<div class="media-preview input-group-addon" style="height:auto">';
...
<a class="btn btn-default" title="<?php echo JText::_('JLIB_FORM_BUTTON_SELECT'); ?>" href="
<?php echo ($readonly ? ''
		: ($link ? $link
			: 'index.php?option=com_media&amp;view=images&amp;tmpl=component&amp;asset=' . $asset . '&amp;author='
			. $authorField) . '&amp;fieldid=' . $id . '&amp;folder=' . $folder) . '"'
	. ' rel="{handler: \'iframe\', size: {x: 800, y: 500}}"'; ?>>
 <?php echo JText::_('JLIB_FORM_BUTTON_SELECT'); ?></a><a class="btn btn-default hasTooltip" title="<?php echo JText::_('JLIB_FORM_BUTTON_CLEAR'); ?>" href="#" onclick="jInsertFieldValue('', '<?php echo $id; ?>'); return false;">
